    ...
    render() {
        return (
            <div className="contact">
                <form name="contact" method="POST" action="/contact-success" onSubmit={this.handleSubmit}>
                    ...
                    <p className="full-width">
                        ...
                        <textarea name="message" id="message" rows="12" required onChange={this.handleChange}/>
                    </p>
                    <Recaptcha
                        ref="recaptcha"
