...
const SoftwareDev = () => (
  <div>
    ...
    <BlueBox>
      ...
      <p style={{ color: '#fff' }}>
        Bei der Umstellung auf ein neues System möchten Sie natürlich nicht auf
        Ihren bisherigen Datensätze verzichten. Auch hier sind wir gerne
        behilflich und schaffen bei Beauftragung eine Schnittstelle zwischen
        Ihren alten Daten und der für Sie entwickelten Software.
      </p>
    </BlueBox>
    <Whitebox>
      <h2>Technologien</h2>
